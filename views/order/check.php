        ...
        <div class="col-xs-12 no-margin">
                ...
                <h2 class="border h1">收货地址</h2>
                    ...
                    <div class="row field-row" style="margin-top:10px">
                        <div class="col-xs-12">
                            ...
                            <!-- <input class="le-radio big address radio_name" type="radio" name="address_val" value="<?php //echo $address['addressid'] ?>" <?php //if ($key == 0) {echo 'checked = "checked"';} ?> /> -->


                            <input class="le-radio big address radio_name" type="radio" name="address_val" value="<?php echo $address['addressid'] ?>"/>
            ...
            <?php foreach($products as $product): ?>
                    <div class="row no-margin order-item">
                        ...
                        <!-- <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>" class="qty"> -->
            ...
            <input type="hidden" name="addressid" class="address_id" value="">
