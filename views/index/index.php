                    ...
                    <?php foreach ($data['tui'] as $pro): ?>
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <img alt="<?php echo $pro->title ?>" src="http://<?php echo $pro->cover ?>-picmiddle" data-echo="http://<?php echo $pro->cover ?>-picmiddle" />
                                </a>
                                </div>
                                <div class="body">
                                    <div class="title">
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                            <img alt="<?php echo $data['all'][$i]->title ?>" src="http://<?php echo $data['all'][$i]->cover ?>-picmiddle" data-echo="http://<?php echo $data['all'][$i]->cover ?>-picmiddle" />
                            </div>
                            <div class="body">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        ...
                        <img alt="<?php echo $last->title ?>" src="http://<?php echo $last->cover ?>-picbig" data-echo="http://<?php echo $last->cover ?>-picbig" />
                            </a>
                    ...
                    <div class="gallery-thumbs clearfix">
                        ...
                        <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key+1; ?>" href="#slide<?php echo $key+2; ?>"><img alt="" src="http://<?php echo $pic ?>-coversmall" data-echo="http://<?php echo $pic ?>-coversmall" /></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
