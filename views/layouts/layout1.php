    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-6 no-margin">
            ...
            <?php if (!\Yii::$app->user->isGuest): ?>
                您好 , 欢迎您回来 <?= \Yii::$app->user->identity->username ?> , <a href="<?php echo yii\helpers\Url::to(['member/logout']); ?>">退出</a>
            <?php else: ?>
...
<a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">
       <!-- <img alt="logo" src="./assets/images/logo.PNG" width="233" height="54"/>-->
		<img alt="logo" src="./assets/images/aurora.png" width="233" height="100"/>
	</a>
</div><!-- /.logo -->
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                <img alt="" src="http://<?php echo $product['cover'] ?>-coversmall" />
                                </div>
                            </div>
            ...
            <li>
                <div class="row">
                    ...
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro->productid]) ?>" class="thumb-holder">
                            <img alt="<?php echo $pro->title ?>" src="http://<?php echo $pro->cover ?>-coversmall" data-echo="http://<?php echo $pro->cover ?>-coversmall" />
                        </a>
                    </div>
                </div>
            </li>
...
<div class="contact-info">
    ...
    <p>
        广东省韶关市浈江区大学路韶关学院北区信息工程楼五楼极光工作室
        <br>极光交流群 (QQ群：539365225)
    </p>
...
<!-- ============================================================= LINKS FOOTER : END ============================================================= -->            </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                &copy; <a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">Aurora.com</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
    ...
    <script>
        ...
        $(".minus").click(function(){
            var cartid = $("input[name=productnum]").attr('id');//返回此元素的ID值
            var num = parseInt($("input[name=productnum]").val()) - 1;
            if (parseInt($("input[name=productnum]").val()) <= 1) {
                var num = 1;
            }
            var total = parseFloat($(".value.pull-right span").html());//获取视图的商品总价
            var price = parseFloat($(".price span").html());//获取视图的商品单价
